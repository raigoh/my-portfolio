  ...
  const projects = [
    {
      ...
      featured: true,
      learnings: [
        "I gained experience in building a modular JavaScript framework from scratch, implementing core functionalities like routing, state management, and component creation",
        "I learned to create a flexible component system using curried functions, making element creation more intuitive and reducing boilerplate code",
        "I developed skills in implementing client-side routing for a single-page application, managing navigation without page reloads",
        "I created a centralized state management system with subscription patterns, enabling reactive UI updates and persistent storage",
        "I built a robust calculator application with both basic and scientific modes, handling complex mathematical operations and user interactions",
        "I implemented server communication using Express.js, creating RESTful endpoints for managing calculation history",
        "I enhanced my understanding of event delegation and DOM manipulation through building custom UI components",
        "I learned to structure a project with clear separation of concerns, dividing framework core functionality from application-specific code",
      ],
      improvements:
    ...
    },
    {
      ...
      featured: true,
      learnings: [
        "I gained hands-on experience in implementing real-time communication using WebSocket and GraphQL subscriptions, enabling instant chat and status updates between users",
        "I developed skills in building secure authentication systems using JWT tokens and handling sensitive user data appropriately",
        "I enhanced my database design abilities with PostgreSQL, implementing complex queries and relationships for user matching and profile management",
        "I improved my frontend development skills using React with TypeScript and Tailwind CSS, creating responsive interfaces that adapt across different devices",
        "I learned to develop and implement matching algorithms, incorporating multiple criteria and weighted scoring systems",
        "I gained experience in building modular, maintainable code architecture, effectively separating frontend and backend concerns",
        "I strengthened my understanding of state management and real-time data synchronization in a full-stack environment",
        "I developed skills in error handling and input validation across both frontend and backend systems",
      ],
      improvements:
    ...
    },
    {
      ...
      featured: true,
      learnings: [
        "I learned how to implement real-time communication between multiple interfaces using Socket.IO, ensuring instant updates across all user screens",
        "I gained experience in building secure authentication systems, implementing role-based access with different keys for each user type",
        "I developed my skills in responsive design, creating interfaces that work seamlessly across mobile, tablet, and desktop devices",
        "I mastered state management across a complex system, keeping race data synchronized between all connected users",
        "I improved my code organization skills by building a modular, event-driven architecture that's easy to maintain and scale",
        "I learned to handle different environment configurations, creating separate settings for development and production",
        "I enhanced my UI/UX skills by designing intuitive interfaces for different user roles, from race officials to spectators",
        "I gained practical experience in handling real-time data updates and race timing systems",
      ],
      improvements:
    ...
    },
    {
      ...
      featured: true,
      learnings: [
        "I learned how to build a complete web application using Go, from routing to database management",
        "I gained practical experience in implementing user authentication and session management",
        "I developed skills in creating and managing SQLite databases with proper table relationships",
        "I improved my understanding of middleware patterns for logging, authentication, and error handling",
        "I learned how to structure a large project with clear separation of concerns and modular components",
      ],
      improvements:
    ...
    },
    {
      ...
      featured: false,
      learnings: [
        "I strengthened my technical expertise through complex problem-solving and efficient code implementation",
        "I developed strong code review skills and learned to provide well-explained feedback to peers",
        "I improved my ability to explain technical decisions and architectural choices clearly",
        "I gained valuable experience in receiving and incorporating peer feedback constructively",
        "I learned the importance of balancing technical excellence with team communication",
      ],
      improvements:
